...
- `report_runs/2026-06-09-main/`: historical 27-run report batch with raw JSONL, summary JSON/Markdown, and generated figures. Its `point/*` rows predate PointMass autoreset during timing and are not valid active-environment throughput evidence; the other rows are unaffected.
